...
!(function (e, t) {
  ...
  function G(e, t) {
    if (t) {
      ...
      return e.replace(i.escapeReplaceNoEncode, N);
    return e;
  }
  function H(e) {
    try {
  ...
  class K {
    ...
    constructor(t) {
      ...
      (this.options.pedantic
        ? ((n.block = M.pedantic), (n.inline = O.pedantic))
        : this.options.gfm &&
          ((n.block = M.gfm),
      ...
      for (; e; )
        if (
          ...
          if ((n = this.tokenizer.escape(e)))
            ...
            ((e = e.substring(n.raw.length)), (s = t[t.length - 1]), t.push(n));
